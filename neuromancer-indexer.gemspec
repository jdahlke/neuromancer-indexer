...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Ruby gem to push data for indexing to the Neuromancer service.}
  spec.description   = %q{Ruby gem to push data for indexing to the Neuromancer service.}
